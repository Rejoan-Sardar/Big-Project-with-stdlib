...
function main() {
	...
	copts.name = 'rational_p48q48';
	str = compileC( P48, Q48, copts );
	file = insert( file, copts.name, str );

	copts.name = 'rational_p816q816';
	str = compileC( P816, Q816, copts );
	file = insert( file, copts.name, str );

	copts.name = 'rational_p16infq16inf';
	str = compileC( P16INF, Q16INF, copts );
	file = insert( file, copts.name, str );
